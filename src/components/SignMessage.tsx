...
import { verifySignature_solana } from "../utils/verifySignature";
...
export const SignMessage: FC = () => {
  ...
  const onClick = useCallback(async () => {
    try {
      ...
      // const message = Buffer.from(LOGIN_MESSAGE);
      ...
      console.log(await verifySignature_solana(signature, message, publicKey));
